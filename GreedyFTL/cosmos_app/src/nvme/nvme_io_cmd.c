...
//			xil_printf("IO Read Command\r\n");
		...
		case IO_NVM_HELLO:
		{
			...
			*/
			...
			xil_printf("Affiliation: Sogang University Computer Science and Engineerinig\r\n");
			xil_printf("Interests: Enbedded Systems and Operating Systems\r\n");
			xil_printf("Hobbies: Soccer, Tennis\r\n");
			nvmeCPL.dword[0] = 0;
			nvmeCPL.specific = 0x0;
			set_auto_nvme_cpl(nvmeCmd->cmdSlotTag, nvmeCPL.specific, nvmeCPL.statusFieldWord);
			// prj2
